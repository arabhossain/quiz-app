            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="profile-head">
                        <h5>{{$user->name}}</h5>
                        <h6>{{$user->roles()->get()->first()->label}}</h6>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form method="POST" action="{{ route('profileUpdate') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="email" placeholder="Email" disabled  type="email" class="form-control @error('email') is-invalid @enderror" value="{{ $user->email }}">
